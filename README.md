...
> ### draft-ietf-grow-bmp-adj-ribs-filtered
...
```
$ xml2rfc draft-ietf-grow-bmp-adj-ribs-filtered.xml --text
Parsing file draft-ietf-grow-bmp-adj-ribs-filtered.xml 
Created file draft-ietf-grow-bmp-adj-ribs-filtered.txt
```
